...
public class Using_isEnable_method {
	WebDriver driver;
	...
	@Test
	public void isEnableMethod() throws InterruptedException {
		boolean signInButton = driver.findElement(By.id("submit_btn")).isEnabled();
		System.out.println("Is the sign in button enable? Ans: " + signInButton);
		Thread.sleep(5000);
